...
dag = DAG('complex_dag', description="Trigger", 
...
task_7 = BashOperator(task_id= "tsk7", bash_command="sleep 5", dag= dag )
task_8 = BashOperator(task_id= "tsk8", bash_command="sleep 5", dag= dag )
